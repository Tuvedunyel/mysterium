...
export default function Form ( { id }: { id: number } ) {
  ...
  const handleSubmit = async ( e: FormEvent<HTMLFormElement> ) => {
    ...
    const response = !isEdit ? await axios.post( `/api/player`,
        options ) : await axios.patch( `/api/player/${ player!.id }`, options );
            ...
            (
                <form className={ styles.form }
                  ...
                  <input type="text"
                         name="nom"
                         id="nom"
                         placeholder="Nom" defaultValue={ player && player.name ? player.name : "" }/>
                  <select name="role"
                          id="role" required defaultValue={ player && player.role ? player.role : "default" }>
                  ...
                  <select name="color"
                          id="color"
                          required defaultValue={ player && player.color ? player.color : "default" }>
